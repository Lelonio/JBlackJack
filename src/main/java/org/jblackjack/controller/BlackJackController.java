...
public class BlackJackController {
    ...
    public void playerHit(int currentPlayerIndex) {
        ...
        if (!this.model.isGameOver()) {
            ...
            Point startPoint = new Point(280, 23);
            Point endPoint = new Point(343 + 20 * (currentPlayer.getHand().size() - 1) + 283 * currentPlayerIndex, 464);
            view.getCardPanel().startPlayerCardAnimation(currentPlayerIndex, startPoint, endPoint);
            view.getCardPanel().repaint();
            isAnimating = true;

            Timer animationTimer = new Timer(1700, e -> {
                isAnimating = false;
    ...
    public void playerStand(int index) {
        ...
        if (nextPlayer != null) {
            ...
            Timer outcomeTimer = new Timer(1000, e -> checkGameStatus());
    ...
    public void betting(int currentPlayerIndex, boolean b) {
        ...
        } else if (model.getPlayers().get(currentPlayerIndex).getAmount() > 0) {
            audioManager.play("credits.wav");
